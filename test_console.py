...
class TestHBNBCommand_create(unittest.TestCase):
    """Unittests for testing the create from the HBNB command interpreter."""
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """Unittests for testing the destroy from the HBNB command interpreter."""
...
class TestHBNBCommand_update(unittest.TestCase):
    """Unittests for testing the update from the HBNB command interpreter."""
